...
public class ExpenseTrackerView extends JFrame {
  ...
  public ExpenseTrackerView() {
    ...
    // Remove grouping in digits (e.g., 1,000 ---> 10)
...
/**
 * This component class handles rendering rows dynamically based on the applied
 * filter.
...
class CustomTableCellRenderer extends DefaultTableCellRenderer {
  ...
  /**
   * This component is used in rendering rows dynamically based on the applied
   * filter.
   * Filtered rows are applied Light green colour.
   *
